...
import { FaGithub, FaGoogle, FaTwitter, FaLinkedin, FaDiscord } from "react-icons/fa";
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden px-4">
      <motion.div
        ...
        className="max-w-md w-full mx-auto rounded-lg p-8 bg-neutral-900 border border-neutral-800 relative z-10 shadow-lg transform hover:scale-105 transition-transform duration-300"
      >

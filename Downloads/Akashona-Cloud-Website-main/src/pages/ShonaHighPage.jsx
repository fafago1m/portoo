...
import { shonahighdata } from '../database/shonahigh';
import { MemoryStick, Cpu, HardDrive, Database, Save } from 'lucide-react';

const ShonaHighPage = () => {
    const { title, description, packages, faq } = shonahighdata[0] || {};
        ...
        return (
            <div>
                ...
                <div className="container mx-auto py-10 text-center">
                    <h2 className="text-2xl font-bold text-white">Error: Data hosting tidak ditemukan</h2>
                </div>
                <FAQ faqData={faq} />
                <Footer />
            </div>
